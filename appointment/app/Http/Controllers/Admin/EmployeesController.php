...
class EmployeesController extends Controller
{
    ...
    public function show($id)
    {
        ...
        $working_hours = \App\WorkingHour::where('employee_id', $id)->get();$appointments = \App\Appointment::where('employee_id', $id)->get();

        $employee = Employee::findOrFail($id);

        return view('admin.employees.show', compact('employee', 'working_hours', 'appointments'));
    }
